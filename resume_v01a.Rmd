...
header-includes:
  ...
  - \setmainfont{Montserrat} #aqui hubo cambio general del doc
  - \setsansfont{Arial}
  - \setmonofont{Arial}
...
RPisco es un paquete desarrollado en R con herramientas para extraer y manipular datos climáticos de PISCO (SENAMHI, Perú). Enlace: https://github.com/GeomarPerales/RPisco

### ESTUDIO HIDROLÓGICO Y ANÁLISIS DE MÁXIMAS AVENIDAS | COLOMBIA

\textcolor{darkgray}{\textbf{\emph{U.M. Quinchia y La Perla}}}

Recopilación, pre-proceso, proceso y análisis de datos hidroclimáticos para la caracterización
hidroclimática, y análisis de máximas avenidas
