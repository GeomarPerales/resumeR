...
para lo cual llevo una preparación autodidacta técnica, cultural y bilingüe.
  ...
  \subsection{IDIOMAS\vspace{-0.35em}}

\textcolor{black}{\textbf{Español}}\vspace{1.3mm}\vfill
- Idioma nativo
\textcolor{black}{\textbf{Quechua}}\vspace{1.3mm}\vfill
- Básico (en proceso)
\textcolor{black}{\textbf{Inglés}}\vspace{1.3mm}\vfill
- Básico (en proceso)
