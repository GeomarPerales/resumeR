...
\begin{figure}[tph]
\begin{minipage}[t]{0.3\textwidth\vspace{-\topskip}}
  \centering
  \vspace{0cm}
...
en Hidráulica, desarrollando modelos de simulación; en liderazgo y trabajo en equipo,
dirigiendo y formando parte de grupos de trabajo durante la universidad y en
el trabajo.
\setlength\parskip{1em}
...
\textcolor{darkgray}{\textbf{Español - nativo}\vfill\vspace{0.1mm}}
\textcolor{darkgray}{\textbf{Quechua - Básico (en proceso)}\vfill\vspace{0.1mm}}
\textcolor{darkgray}{\textbf{Inglés- Básico (en proceso)}\vfill\vspace{0.1mm}}

  \subsection{REFERENCIAS\vspace{0em}}
  
Ing. Gustavo Atúncar

Especialista de Hidrología e Hidráulica

Cel. N° 939272465

Ing. Yonatan Bustamante
...
Ing. Elvis Castro
Jefe del área de Recursos Hídricos, SRK
Cel. N° 956302303
...
\vspace{1mm}
  ...
  \hfill
  %
  \begin{minipage}[t]{0.65\textwidth\vspace{-\topskip}}
  \justify
...
\begin{figure}[tph]
  \begin{minipage}[t]{0.17\textwidth\vspace{-\topskip}}
...
alfa
  ...
  \hfill
  %
  \begin{minipage}[t]{0.83\textwidth\vspace{-\topskip}}
  \justify
...
caracterización climática, modelamiento hidrológico y análisis de máximas avenidas,
análisis de sequías, planes de gestión hídrica, uso de lenguajes de programación
(R y Python) para automatizar actividades, y análisis de datos espaciales y no
espaciales.
\vspace{5mm}
...
Recopilación, pre-proceso, proceso y análisis de datos hidroclimáticos para
caracterización climática, modelamiento hidrológico y análisis de máximas avenidas,
análisis de sequías, planes de gestión hídrica, uso de herramientas SIG para el
análisis geoespacial y desarrollo de mapas temáticos, modelamiento de balance de
aguas en GoldSim, uso de lenguajes de programación (R y Python) para automatizar
actividades, y análisis de datos espaciales y no espaciales.
\vspace{5mm}
...
hidrológico, eventos extremos, planes de gestión hídrica, Dibujante CAD de planos
hidráulicos, abastecimiento y drenaje, SIG para el análisis, proceso geoespacial
en hidráulica e hidrología y creación de mapas.
\vspace{5mm}
...
extremos y recursos hídricos, redacción y revisión parcial de informes y anexos,
procesamiento geoespacial usando herramientas SIG
\vspace{5mm}
...
\vspace{1mm}\vfill
ideamR es un paquete desarrollado en R para el manejo de datos hidrometeorológicos
de DHIME(IDEAM, Colombia). DHIME es un Sistema de Información para el manejo de
datos hidrológicos y meteorológicos de Colombia. Enlace: https://github.com/GeomarPerales/ideamR
\vspace{5mm}
...
\textcolor{darkgray}{\textbf{\emph{Software para la automatización de procesos hidrológicos}}}
\vspace{1mm}\vfill
RPisco es un paquete desarrollado en R con herramientas para extraer y manipular
datos climáticos de PISCO (SENAMHI, Perú). Enlace: [RPisco](https://github.com/GeomarPerales/RPisco).
